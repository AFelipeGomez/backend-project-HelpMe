...
public class AuthExceptionOwn implements AuthenticationEntryPoint{
	...
	public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException arg2)
		...
		ExceptionWrapper ew = new ExceptionWrapper(HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.toString(),"No esta aurotizado para este recurso",request.getServletPath());
